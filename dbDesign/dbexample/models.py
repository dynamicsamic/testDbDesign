...
class Product(AutoGeneratedSlugModel):
    # Think about `unique attrs` to create version names from
...
class ProductVersionManager(models.Manager):
    def create(self, **kwargs):
        ...
        p_version = super().create(name=p_name, **kwargs)
        p_version.set_sku()
...
class ProductVersion(models.Model):
    ...
    product = models.ForeignKey(
        ...
        help_text=_("general product of this version"),
    )
    ...
    def create(self, **kwargs: Mapping[str, Any]) -> "CartItem":
        ...
        try:
            cart_item = self.model.objects.get(
                cart_id=cart.id, p_version_id=p_version.id
            )
